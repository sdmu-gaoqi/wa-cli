...
const urls = new Map();
urls.set("vite单页面-redux", "github:GQ-OG/redux-tookit-app");
urls.set("vue后台项目", "git@github.com:sdmu-gaoqi/vite-vue.git#template");
...
urls.set("react-redux", "github:GQ-OG/redux-tookit-app");
